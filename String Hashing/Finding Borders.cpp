...
// Solution Link: https://www.youtube.com/watch?v=RoGuguexBUA


// This Problem can also be done using z_function
...
int main() {
    ...
    for(int i=0; i<n-1;i++){
        if(obj.hashCode(0,i) == obj.hashCode(n-1-i,n-1))    cout<<i+1<<" ";
    }
